...
hi NonText	guibg=bg   guifg=#000099   gui=bold
hi Visual	guibg=#fff8cc   guifg=black	gui=none
" hi VisualNOS

hi Linenr	guibg=bg	guifg=#efefef gui=none
...
hi Comment guibg=bg guifg=#ababab gui=none

hi Constant	guibg=bg    guifg=#003399 gui=bold
hi String	guibg=bg    guifg=#007700 gui=italic
