...
hi Cursor	guifg=White guibg=grey80
hi lCursor	guifg=White guibg=grey80
hi Directory	guifg=Blue guibg=bg
hi LineNr	guifg=Brown guibg=bg
hi MoreMsg	gui=NONE guifg=SeaGreen guibg=bg
hi NonText	gui=NONE guifg=Blue guibg=bg
...
hi FoldColumn	guifg=DarkBlue guibg=bg
