...
local config = {
	...
	mappings = {
		...
		n = {
			...
			["<leader>ss"] = { ":silent !open `ls -t tmp/capybara/*.png | head -n1` <cr>", desc = "" },

			-- toggle indent lines
			["<leader>il"] = { ":IndentBlanklineToggle<cr>", desc = "" },
		},
		i = {
	...
	polish = function()
		...
		--require("luasnip.loaders.from_snipmate").lazy_load({ paths = "~/dotfiles/astrovim_config/snippets" })
	end,
}
